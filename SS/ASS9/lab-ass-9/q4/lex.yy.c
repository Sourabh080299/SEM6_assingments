...
static yyconst short int yy_base[22] =
    {   0,
        0,    0,   18,   19,    0,    0,    3,   13,    0,   12,
        5,    0,   10,    0,    0,    0,    0,   19,   12,   11,
       10
    } ;

static yyconst short int yy_def[22] =
    {   0,
       18,    1,   18,   18,   19,   20,   18,   19,    8,   20,
       18,    7,   11,   21,   11,   13,   21,    0,   18,   18,
       18
    } ;

static yyconst short int yy_nxt[26] =
    {   0,
        4,    5,    6,    4,    7,    8,   11,   12,    9,   15,
       16,   17,   10,    9,   16,   14,   13,   18,    3,   18,
       18,   18,   18,   18,   18
    } ;
